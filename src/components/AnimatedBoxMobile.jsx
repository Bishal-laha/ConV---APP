...
const AnimatedBoxMobile = () => {
    ...
    return (
        <Drawer open={isMenu}>
            <motion.div className="bg-blue-400 w-full h-screen clip-square"
            ...
            >
                <div className={`${animationComplete ? "opacity-100" : "opacity-0"} relative`}>
                    ...
                    <h1 className="font-bold w-full text-[2rem] mt-5 bg-gradient-to-r from-[#ffa974] to-[#ff1cb0] bg-clip-text text-transparent text-center">Welcome To <span>ConV</span></h1>
                    <div className="w-[90%] mt-[30%] mx-auto cursor-pointer">
                        <div className="flex justify-between items-center gap-[3rem] bg-white rounded-xl p-2 shadow-2xl hover:scale-105 hover:duration-300 duration-300 " onClick={() => {
                            if (isFileComp) {
                        ...
                        <div className="flex justify-between items-center gap-[3rem] bg-white mt-[10%] rounded-xl py-2 px-4 shadow-2xl hover:scale-105 hover:duration-300 duration-300 " onClick={() => {
                            if (isImageComp) {
                                dispatch(setIsImageComp(false));
                                dispatch(setIsTextComp(true));
                            } else {
